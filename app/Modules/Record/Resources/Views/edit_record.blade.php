...
@section('content')
    ...
    <div class="container-fluid">
        <!-- BreadCrumb -->
        @include('layouts.admin.admin-breadcrumb',['breadcrumbs' => [['name' => 'Record', 'url' =>route('admin.record.list')],['name' => 'Edit', 'url' =>'']]])
            ...
            <div class="col">
                <div class="card mb-grid">
                    ...
                    <div class="card-body collapse show" id="card1">
                        ...
                        <form method="POST" action="{{route('admin.record.update', ['id' => $record->id])}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            {{ method_field('PUT') }}
                            <div class="col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="" value="{{old('name', $record->name)}}">
                                                ...
                                                <select class="form-control m-bot15" name="doctor_id">
                                                    ...
                                                    @if ($doctorList->count())
                                                        @foreach($doctorList as $doctor)
                                                            <option value="{{ $doctor->id }}" {{ old('doctor_id', $record->doctor_id) == $doctor->id ? 'selected="selected"' : '' }}>{{ ($doctor->first_name) }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input class="form-control" id="date" type="text" name="date" value="{{ Request::get('date')}} {{old('date', $record->date)}}" readonly/>
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" class="form-control" id="time" name="time" placeholder="" value="{{old('time', $record->time)}}">
                                            ...
                                            <div class="col-md-4 form-group">
                                              ...
                                              <input  type="text" name="limit" id="limit" class="form-control" placeholder="" value="{{old('limit', $record->limit)}}">
