...
@section('content')
    <div class="container-fluid">
        <!-- BreadCrumb -->
        @include('layouts.admin.admin-breadcrumb',['breadcrumbs' => [['name' => 'User', 'url' =>route('admin.user.list')],['name' => 'Edit', 'url' =>'']]])
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <select name="title" class="custom-select form-control" id="title">
                                                    ...
                                                    <option value="Mrs" {{ old('title') == 'Mrs' ? 'selected': $user->title == 'Mrs' ? 'selected': '' }}>Mrs</option>
                                                    <option value="Miss" {{ old('title') == 'Miss' ? 'selected': $user->title == 'Miss' ? 'selected': '' }}>Miss</option>
                                                    <option value="Ms" {{ old('title') == 'Ms' ? 'selected': $user->title == 'Ms' ? 'selected': '' }}>Ms</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input  type="text" name="first_name" id="first_name" class="form-control" placeholder="" value="{{old('first_name', $user->first_name)}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input  type="text" name="last_name" id="last_name" class="form-control" placeholder="" value="{{old('last_name', $user->last_name)}}">
